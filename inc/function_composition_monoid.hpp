// function_composition_monoid.hpp
...
//
//
#ifndef FUNCTION_COMPOSITION_MONOID_HPP
#define FUNCTION_COMPOSITION_MONOID_HPP
...
namespace artin
{
  ...
  */
  ...
  struct unary_func
  {
    ...
    result_type operator()(const argument_type& p) const { return _unary_op(p); }
  };
...
#endif //FUNCTION_COMPOSITION_MONOID_HPP
